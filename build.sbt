...
libraryDependencies ++= Seq(
  ...
  "org.eclipse.jetty"             % "jetty-server"         % "8.1.22.v20160922" % "test",
  "org.eclipse.jetty"             % "jetty-servlet"        % "8.1.22.v20160922" % "test",
  "org.eclipse.jetty"             % "jetty-servlets"       % "8.1.22.v20160922" % "test"
)
